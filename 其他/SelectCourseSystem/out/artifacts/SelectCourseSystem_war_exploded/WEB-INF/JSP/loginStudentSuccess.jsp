    ...
    <div class="middle1">
        ...
        <div class="middle1-right">
            <div class="middle2_1">
                ...
                <input name="submit" type="button" value="进入选课系统" onclick="window.location.href='/SelectCourseSystem_war_exploded/addTable.action'"/>
                <input name="submit" type="button" value="查询当前课表" onclick="window.location.href='/SelectCourseSystem_war_exploded/showTable.action'"/>
            </div>
        </div>
    </div>
</div>
